...
MetronicApp.controller('AccountController', ['$rootScope', '$scope', '$http', 'settings', 'Info', 'Profile', '$location',  function($rootScope, $scope,$http, settings, Info, Profile, Pas, $location) {
